#!/usr/bin/env python3
"""
Test script for PR #99 - AI-172 Deepgram multilingual evaluation
Tests all core modules without requiring the whisper.cpp submodule
"""
...
print("=" * 70)
print(" 🧪 PR #99 TESTING - AI-172 Foundation for Deepgram Multilingual STT")
print("=" * 70)
...
try:
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        report = generate_report(api_key="test_key", languages=['en', 'hi'], output_path=output_path)
        
        print(f"\n  Report generated successfully")
        print(f"  Languages evaluated: {', '.join(report['languages_evaluated'])}")
