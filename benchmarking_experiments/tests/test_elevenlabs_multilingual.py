# benchmarking_experiments/tests/test_elevenlabs_multilingual.py
...
from providers.elevenlabs import ElevenLabsTTSProvider, ElevenLabsSTTProvider
...
RESULTS_DIR = Path(__file__).parent.parent / "results" / "elevenlabs"
...
async def run_tts_benchmark():
    print("\n========== ELEVENLABS TTS BENCHMARK ==========")
    all_results = []

    for lang, sentences in TEST_SENTENCES.items():
        provider = ElevenLabsTTSProvider(language=lang)
        lang_results = []
...
async def run_stt_benchmark():
    print("\n========== ELEVENLABS STT BENCHMARK (round-trip) ==========")
    all_results = []

    for lang, sentences in TEST_SENTENCES.items():
        tts = ElevenLabsTTSProvider(language=lang)
        stt = ElevenLabsSTTProvider(language=lang)
        lang_results = []
...
async def main():
    ...
    print("\nAll results saved to: benchmarking_experiments/results/elevenlabs/")
